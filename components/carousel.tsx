...
function Carousel({
  ...
  // Normalize `align` from props or opts, and only allow supported string values.
  ...
  const carouselOptions: CarouselOptions = {
    ...
    watchDrag: draggable ?? opts?.watchDrag,
  ...
  React.useEffect(() => {
    ...
    function handleSelect(currentApi: CarouselApi) {
      ...
      // Keep navigation state and external listeners in sync with Embla.

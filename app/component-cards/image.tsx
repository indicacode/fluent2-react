    ...
    },
    {
      ...
      cardComponent: (
        <div className="box-border flex flex-col gap-3 text-2xl font-semibold">
          <p>None</p>
          <div className="h-32 w-96 overflow-hidden border border-border">
            <Image
              fit="none"
          ...
          <p>Center</p>
          <div className="flex h-32 w-96 items-center justify-center border border-border">
            <Image
          ...
          <p>Contain</p>
          <div className="flex h-[200px] w-[450px] items-center justify-center overflow-hidden border border-border">
            <Image
              fit="contain"
              src={
          ...
          <p>Cover</p>
          <div className="flex h-[200px] w-[400px] items-center justify-center overflow-hidden border border-border">
            <Image
              fit="cover"
              src={

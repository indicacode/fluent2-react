...
function Card({
  ...
  // Inject orientation (and image for header) into child slots.
  ...
  return (
    <div
      ...
      onClick={() => {
        ...
        // Controlled cards delegate state to the parent.
        if (isControlled) {
...
function CardContent({
  ...
  // CardContent is a vertical-only slot.
...
function CardFooter({
  ...
  // CardFooter is a vertical-only slot.
  if (orientation === "horizontal") {
    return null
  }
  return (

    ...
    },
    {
      ...
      cardComponent: (
        <Accordion type="single">
          <AccordionItem value="item-1">
            <AccordionTrigger as="h1">Accordion Trigger as h1</AccordionTrigger>
            <AccordionContent>Accordion Content 1</AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger as="h2">Accordion Trigger as h2</AccordionTrigger>
            <AccordionContent>Accordion Content 2</AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            <AccordionTrigger as="h3">Accordion Trigger as h3</AccordionTrigger>
      ...
      cardComponent: (
        <Accordion type="single">
          <AccordionItem disabled value="item-1">
            <AccordionTrigger as="h1">Is it easy to use?</AccordionTrigger>
            <AccordionContent>
              Yes. Try it for yourself, with a few lines of code you get
              beautiful UI!
            </AccordionContent>
          ...
          <AccordionItem disabled value="item-2">
            <AccordionTrigger as="h2">Is it styled?</AccordionTrigger>
            <AccordionContent>
              Yes. It comes with default styles that matches the Fluent2
              Aesthetic!
            </AccordionContent>
          ...
          <AccordionItem disabled value="item-3">
            <AccordionTrigger as="h3">Is it animated?</AccordionTrigger>
            <AccordionContent>
              Yes. It's animated by default with a smooth expanding motion, you
              can disable animations.
            </AccordionContent>

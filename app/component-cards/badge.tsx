...
export const badge_card = {
  ...
  cards: [
    ...
    },
    {
      ...
      cardComponent: (
        <div className="flex items-center gap-2">
          <Badge size="tiny">9</Badge>
          <Badge size="extra-small">9</Badge>
          <Badge size="small">9</Badge>
          <Badge size="medium">9</Badge>
          <Badge size="large">9</Badge>
          <Badge size="extra-large">9</Badge>
        </div>
      ),
    },
    {
      ...
      cardComponent: (
        <div className="flex gap-2">
          <Badge shape="square">9</Badge>
          <Badge shape="rounded">9</Badge>
          <Badge shape="circular">9</Badge>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      cardComponent: <Badge icon={<AiFillCalendar />}>99+</Badge>,
    },
  ],
}

...
export function NavHeader({ href, logo: Logo, children }: NavHeaderProps) {
  return (
    <a
      href={href}
...
export function NavCategory({ icon: Icon, title, children }: NavCategoryProps) {
...
export function NavSubItem({ children, href, onClick }: NavSubItemProps) {
  const searchParams = useSearchParams()
  const isActive = searchParams.get("section") === String(children)

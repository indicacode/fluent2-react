import { Dropdown, Option, OptionGroup } from "@/components/dropdown"
  ...
  cards: [
    ...
    },
    {
      ...
      cardComponent: (
        <div className="flex w-[380px] flex-col gap-4">
          ...
          <div className="bg-neutral-800 px-6 py-3 text-primary-foreground">
    ...
    },
    {
      ...
      cardComponent: (
        <div className="w-[300px]">
          <label>
            Best Pet <span className="text-destructive">*</span>
          </label>

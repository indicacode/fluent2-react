...
function TeachingPopoverTitle({
  ...
  return (
    <div data-slot="teaching-popover-title" className={title({ className: className as string })} {...props} />
  )
}
...
function TeachingPopoverBody({
  ...
  return (
    <div data-slot="teaching-popover-body" className={body({ className: className as string })} {...props} />
  )
}
...
function TeachingPopoverFooter({
  ...
  return (
    <div data-slot="teaching-popover-footer" className={footer({ className: className as string })} {...props} />
  )
}
